...
class PlaceResource(Resource):
    ...
    def get(self, place_id):
        ...
        return {
            ...
            'reviews': [{'id': review.id, 'author_first_name': review.author.first_name, 'author_last_name': review.author.last_name, 'text': review.text, 'rating': review.rating} for review in place.reviews]
        }, 200
